  ...
  const interests = [
    ...
    { image: "https://i.pinimg.com/originals/00/e5/74/00e5749247f68290c03effa5c2888213.jpg", title: "...", description: "..." },
    ...
    { image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTs2fphsHk4KSgHqAETKBZdjCKb1rHwDkW4nw&s", title: "...", description: "..." },
  ...
  const education = [
    ...
    },
    {
      ...
      description: "PLP taught me programming skills focusing on web development and specialization in AI in Software Engineering. Completed various modules and personal projects to strengthen technical abilities.",
      image: "/api/placeholder/400/250",
      technologies: ["Python", "JavaScript", "HTML/CSS", "ML", "AI", "SQL", "TensorFlow"],
      github: "#",
      demo: "#"
    },
    {
  ...
  const skills = [
    ...
    },
    {
      ...
      items: [
        { name: "Physics", level: 10 },
        { name: "Mathematics", level: 10 },
  ...
  window.addEventListener('load', function() {
    ...
    // Initialize sections - FIXED BY ADDING renderEducation()
    renderInterests();
    renderEducation();
    renderProjects();
    renderSkills();
  ...
  document.getElementById('contactForm').addEventListener('submit', function(e) {
    ...
    // Typically send the form data to my server
  ...
  // Make sure all DOM elements are loaded before accessing them
  ...
  // Animation on scroll (for when the skills section comes into view)
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function animate() {
      ...
      stars.forEach(star => {
        ...
        // Gravity effect - pull stars toward black hole
        ...
        if (distanceSquared < accretionDiskRadius * accretionDiskRadius * 10) {
          ...
          // If star gets too close to black hole, reset it
